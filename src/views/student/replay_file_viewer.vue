<template>
    <div>
        <div class="viewFile">
            <div style="height:10%; position: relative; left: 2%; display: flex;"> 
                <h3 style="margin: 15px; position: relative; top: 10px;">正在查看课件：{{filename}} 该课件今日已学习 {{watch_time}} 分钟</h3>
                ...
                <el-button @click="prevFile" type="primary" style="margin: 15px;">上一课件</el-button>
                <el-button @click="nextFile" type="primary" style="margin: 15px;">下一课件</el-button>
